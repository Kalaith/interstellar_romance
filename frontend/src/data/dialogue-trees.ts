...
export function processDialogueConsequence(
  ...
  const consequences: Record<string, string> = {
    ...
    'Seraphina seems deeply moved by your words':
      "Seraphina's ethereal essence resonates with yours. A mystical bond is forming.",
    'Thessarian seems scientifically curious about romance':
      'Thessarian begins analyzing romantic interactions with scientific fascination.',
    'You feel a deeper spiritual connection forming':
      'The dimensional barriers between your souls grow thinner.',
  };
