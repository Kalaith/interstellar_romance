...
export const KYRATHEN_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*Kyra'then gazes toward the horizon, his feathers ruffled by an unseen burden* You know, bringing the tribes together... it wasn't just about strategy. Each clan had lost so much to conflict. I had to prove that unity didn't mean losing their identity.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*His eyes gleam with ancient memory* There is a ritual... the Sacred Flight. When two souls wish to bond, they dance together among the clouds. It's said that if their hearts truly match, the wind itself will carry them as one. I... I haven't performed this ritual in many years.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*He spreads his wings protectively around you both* I've always believed a leader must sacrifice personal happiness for their people. But with you... I wonder if perhaps love and duty can coexist. You make me want to be more than just a chieftain.",
    unlocked: false,
    completed: false,
    choices: [
      {
...
export const SERAPHINA_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*Her ethereal form flickers with melancholy* To see across dimensions is both blessing and curse. I've witnessed countless possible futures... some filled with joy, others with sorrow. Sometimes I wonder if it's better to live without knowing what may come.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*She extends her luminous hand* Come with me to a place between dimensions. There, in the Void Garden, time moves differently. We can experience lifetimes together in moments, or single heartbeats that last eternities.",
    unlocked: false,
    completed: false,
    choices: [
      {
...
export const KRONOS_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*Kronos gestures to his complex neural interfaces* You know, for all my enhancements and multiple processing cores, the most complex puzzle remains unsolved: emotion. Logic tells me love is merely neurochemical cascades, yet... when I'm with you, I feel something beyond data.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*His neural implants pulse with excitement* I've been developing something unprecedented... a temporary consciousness bridge. Two minds sharing experiences directly, feeling what the other feels. It's never been tested between species. Would you... would you be willing to be my first?",
    unlocked: false,
    completed: false,
    choices: [
      {
    ...
    rewards: [
      {
        ...
        description: 'A beautiful moment showing his enhanced and natural selves in perfect balance'
      }
    ]
  }
];
...
export const THESSARIAN_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*Dr. Thessarian's bio-luminescent markings pulse thoughtfully* I've been analyzing something fascinating... the genetic and biological compatibility between different species. Specifically, I've been studying... us. The data suggests remarkable adaptive potential.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*Their excitement is barely contained* I've developed a temporary symbiotic enhancement... it would allow us to share biological processes, feel each other's heartbeats, synchronized breathing. It's never been tested between our species. Would you trust me enough to try?",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*After the symbiosis experience, their bio-markings pulse in perfect harmony* Remarkable... the data shows something I never expected. Love isn't just compatible across species—it actively enhances biological adaptation. We're not just two beings coexisting; we're evolving together into something new.",
    unlocked: false,
    completed: false,
    choices: [
      {
...
export const LYRALYNN_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*Lyralynn's petals droop slightly* I must tell you something... I once loved deeply, but they couldn't understand my connection to the plant world. They called it unnatural, said I loved the garden more than them. The pain... it made my roots grow inward, protecting my heart like thorns.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*She takes your hand with a vine-like tendril* There's a place... my Sacred Grove, where I go when I need healing. No one else has ever seen it. The plants there respond to emotions, blooming with joy, wilting with sorrow. Would you... would you like to see my heart's true garden?",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*In the Sacred Grove, flowers bloom magnificently around you both* Look... the garden responds to us together. When I was hurt before, everything withered. But now... everything blooms brighter than ever. You've helped me learn that love doesn't diminish my connection to nature—it enhances it.",
    unlocked: false,
    completed: false,
    choices: [
      {
...
export const ZARANTHA_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*Commander Zarantha's scales dim slightly* You know what no one understands? Being strong all the time is exhausting. Everyone expects the dragon commander to never show weakness, never need support. But with you... I wonder what it would be like to let someone else be strong for once.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*Her scales bristle with conflict* A rival commander has challenged my authority, claiming I've grown soft since... since I've been with you. Traditional law demands an honor duel. If I lose, my rank, my reputation... everything I've built could be stripped away. But if I win by being ruthless, will I lose the gentleness you've taught me?",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*After winning the duel with honor intact* I won... but not the way I used to. I fought with controlled strength, with honor, with the knowledge that someone precious was watching. They called me soft, but what they saw was actually a new kind of strength—one tempered by love, not weakened by it.",
    unlocked: false,
    completed: false,
    choices: [
      {
...
export const THALASSOS_STORYLINE: StorylineEvent[] = [
  {
    ...
    dialogue: "*High Priest Thalassos gazes into the distance* The deep waters teach many things, but perhaps the most difficult lesson is solitude. To truly commune with the ocean's wisdom, one must often walk alone. Yet lately... I find myself yearning for a companion who could understand both the surface and the depths.",
    unlocked: false,
    completed: false,
    choices: [
      {
  ...
  },
  {
    ...
    dialogue: "*His bio-luminescent patterns pulse with ancient rhythm* There is a ceremony... the Joining of Tides, where two souls share the ocean's deepest secrets. It requires complete trust, complete vulnerability. The waters will show us visions of possible futures together. Are you prepared for what we might see?",
    unlocked: false,
    completed: false,
    choices: [
      {
...
export const NIGHTSHADE_STORYLINE: StorylineEvent[] = [
  ...
  },
  {
    ...
    dialogue: "*Alarms pulse through the dimensional fabric* There's been a breach... a dangerous entity from a hostile dimension is trying to break through. My duty demands I seal it immediately, but... the process will cut me off from this reality for days, maybe weeks. I might not make it back. But if I don't go...",
    unlocked: false,
    completed: false,
    choices: [
      {
