...
export const datePlans: DatePlan[] = [
  // Intellectual Activities
  {
    ...
    description: 'Explore the cosmos together at the galactic observatory, discussing star formations and cosmic phenomena.',
  ...
  },
  {
    ...
    description: 'Walk through exhibits of alien life forms while discussing the wonders of biological diversity.',
    activityType: 'intellectual',
  ...
  // Adventurous Activities
  {
    ...
    description: 'Pilot through colorful nebulae in a small craft, experiencing the thrill of space flight together.',
  ...
  },
  {
    ...
    description: 'Try your hand at asteroid mining together, learning teamwork while seeking rare crystals.',
    activityType: 'adventurous',
  ...
  },
  {
    ...
    description: 'Play anti-gravity sports in a fun, competitive environment that tests coordination and trust.',
    activityType: 'adventurous',
  ...
  // Romantic Activities
  {
    ...
    description: 'Watch the breathtaking binary sunset from the observation deck while sharing intimate conversation.',
  ...
  // Cultural Activities
  {
    ...
    description: 'Explore artistic expressions from different alien cultures, discussing creativity and meaning.',
  ...
  },
  {
    ...
    description: 'Experience food, music, and traditions from various alien civilizations together.',
    activityType: 'cultural',
  ...
  },
  {
    ...
    description: 'Listen to music created by alien instruments and voices in perfect harmonic resonance.',
    activityType: 'cultural',
  ...
  // Relaxing Activities
  {
    ...
    description: 'Find inner peace together in a tranquil meditation space designed for mental harmony.',
  ...
  // Creative Activities
  {
    ...
    description: 'Create a piece of art together using materials and techniques from both your cultures.',
  ...
  },
  {
    ...
    description: 'Learn to prepare dishes from each other\'s cultures in a fun, hands-on cooking experience.',
    activityType: 'creative',
