...
export const checkPhotoUnlocks = (photos: CharacterPhoto[], affection: number): CharacterPhoto[] => {
...
export const getPhotosByRarity = (photos: CharacterPhoto[], rarity: PhotoRarity): CharacterPhoto[] => {
...
export const getNextPhotoToUnlock = (photos: CharacterPhoto[], currentAffection: number): CharacterPhoto | null => {
