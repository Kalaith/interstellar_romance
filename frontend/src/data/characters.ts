...
const defaultMilestones = [
  {
    id: 'first_meeting',
    name: 'First Meeting',
    description: 'Your first encounter',
    unlockedAt: milestoneThresholds.FIRST_MEETING,
    achieved: false,
  },
  {
    ...
    unlockedAt: milestoneThresholds.GETTING_CLOSER,
    achieved: false,
  },
  {
    id: 'personal_sharing',
    name: 'Personal Sharing',
    description: 'Opening up about themselves',
    unlockedAt: milestoneThresholds.MUTUAL_INTEREST,
    achieved: false,
  },
  {
    id: 'first_date',
    name: 'First Date',
    description: 'Your first romantic encounter',
    unlockedAt: milestoneThresholds.ROMANTIC_TENSION,
    achieved: false,
  },
  {
    id: 'deeper_connection',
    name: 'Deeper Connection',
    description: 'Understanding each other better',
    unlockedAt: milestoneThresholds.DEEP_CONNECTION,
    achieved: false,
  },
  {
    id: 'commitment',
    name: 'Committed Relationship',
    description: 'Taking things to the next level',
    unlockedAt: milestoneThresholds.COMMITMENT,
    achieved: false,
  },
];
...
export const CHARACTERS: Character[] = [
  {
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('kyrathen'),
        title: 'Tribal Portrait',
        description: 'In ceremonial feathered headdress',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('seraphina'),
        title: 'Hooded Oracle',
        description: 'In traditional temple robes',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('thessarian'),
        title: 'Laboratory Portrait',
        description: 'In formal research attire',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    profile: {
      ...
      dealbreakers: [
        ...
        'Artificial enhancement addiction',
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('lyralynn'),
        title: 'Forest Guardian',
        description: 'Among her beloved plants',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('zarantha'),
        title: 'Command Portrait',
        description: 'In military dress uniform',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    profile: {
      interests: [
        ...
        {
          id: 'history',
          name: 'Aquatic Civilizations',
          category: 'culture',
          intensity: 4,
        },
      ],
      dealbreakers: [
        'Disrespect for sacred traditions',
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('thalassos'),
        title: 'Ceremonial Robes',
        description: 'In traditional temple attire',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('nightshade'),
        title: 'Shadow Form',
        description: 'In operational attire',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
  ...
  },
  {
    ...
    photoGallery: [
      {
        id: 'portrait',
        url: getCharacterImage('kronos'),
        title: 'Research Station',
        description: 'In his laboratory',
        unlockedAt: 0,
        unlocked: true,
        rarity: 'common',
      },
