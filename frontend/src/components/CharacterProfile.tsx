...
export const CharacterProfile: React.FC = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: 'Interests',
      icon: '🎯',
      available: knownInfo.interests,
    },
    {
      id: 'values' as TabType,
      label: 'Values',
      icon: '💎',
      available: knownInfo.values,
    },
    {
      id: 'background' as TabType,
      label: 'Background',
      icon: '📖',
      available: knownInfo.background,
    },
    {
      ...
      case 'overview':
        return (
          <div className="space-y-6">
            ...
            <div className="bg-[var(--bg-section)] border border-[var(--border-inner)] rounded-lg p-6">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div className="flex-1">
                  ...
                  {knownInfo.species ? (
                    <p className="text-[var(--accent-teal)] font-medium mb-2">
            ...
            {/* Milestones */}
            <div className="bg-[var(--bg-section)] border border-[var(--border-inner)] rounded-lg p-6">
              <h3 className="text-lg font-bold text-[var(--accent-cyan)] uppercase tracking-wide mb-4">
          ...
          return (
            <div className="text-center py-12">
              ...
              <p className="text-[var(--text-secondary)]">
                Reach 10 affection to learn about their interests and hobbies.
              </p>
            </div>
          );
        }
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <span
                          key={i}
                          className={`text-lg ${i < interest.intensity ? 'text-[var(--resource-energy)]' : 'text-[var(--text-muted)]'}`}
                        >
                          ⭐
                        </span>
                      ))}
